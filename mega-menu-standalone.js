...
(function () {
  ...
  const MEGA = [
    {
      ...
      featured: {
        image: window.__resources.mega_drawer,
        kicker: 'IN FOCUS',
    ...
    },
    {
      ...
      featured: {
        image: window.__resources.mega_hinges,
        kicker: 'NEW SERIES',
    ...
    },
    {
      ...
      featured: {
        image: window.__resources.mega_kitchen,
        kicker: 'SPECIFIED',
    ...
    },
    {
      ...
      featured: {
        image: window.__resources.mega_wardrobe,
        kicker: 'CASE STUDY',
    ...
    },
    {
      ...
      featured: {
        image: window.__resources.mega_lights,
        kicker: 'NEW',
    ...
    },
    {
      ...
      featured: {
        image: window.__resources.mega_locks,
        kicker: 'FINISH RANGE',
  ...
  function renderCol3() {
    ...
    col3.innerHTML = sub.items.map((it) => `
      <li>
        <a href="${it.href}" class="mega-row" data-href="${it.href}">
